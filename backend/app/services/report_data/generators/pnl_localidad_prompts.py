...
def generate_fallback_narrativas(datos: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "atencion_2": "Monitorear la evolución de gastos y su impacto en la rentabilidad.",
        "recomendacion_1": "Analizar mix de servicios por localidad para identificar oportunidades de crecimiento.",
        "recomendacion_2": "Revisar la estructura de gastos por localidad para optimizar márgenes.",
